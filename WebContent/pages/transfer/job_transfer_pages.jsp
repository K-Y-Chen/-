			...
			<div class="layui-tab" lay-filter="myPage">
				...
				<div class="layui-tab-content">
					<div class="layui-tab-item layui-show">
						...
						<form action="/code/JobTransServlet">
						<tr>
							<td>
					...
					<div class="layui-tab-item">
						<table class="layui-table">
							...
							<tbody>
				<c:forEach items="${requestScope.jt }" var = "j">
						<tr>
							<td>${j.jt_staffId.s_id }</td>
							<td>${j.jt_staffId.s_name }</td>
							<td>${j.jt_preJob.j_name }</td>	
							<td>${j.jt_job.j_name }</td>
	...
	<script>					
		function toUrl(url){			
			location.href = url;				
				...
				<button type="submit" class="layui-btn" onClick="javascript:toUrl('/code/JobExportServlet')">
				导出表格</button>
